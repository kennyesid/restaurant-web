export enum OrderStatusEnum {
    ENVIADO = 1,       // El cliente ya pagó, el pedido entra a la lista.
    PENDIENTE = 2,    // El cocinero lo vió y lo está preparando.
    EN_PREPARACION = 3,        // El plato está en el mostrador esperando al mesero.
    ENTREGADO = 4,    // Fin del ciclo.
    CANCELADO = 5,     // Por si hubo algún error o devolución.
    PAGADO = 6     // Por si hubo algún error o devolución.
}
